 ...
 * Description:       Advertises and validates user-curated Markdown companion files and llms.txt for AI agents, with admin health checks and safe .htaccess compatibility.
 * Version:           2.2.0
...
define( 'BLOGLOGISTICS_MFA_VERSION', '2.2.0' );
